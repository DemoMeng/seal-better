package com.mqz.seal.v1.ps.reponsitory;
...
public class CFXRepository {
     ...
     * @return
     */
    public static BufferedImage drawTwoFont(BufferedImage bi, Graphics2D g2d, SealDTO font, int lineSize,
     ...
     * @return
     */
    public static BufferedImage drawThreeFont(BufferedImage bi, Graphics2D g2d, SealDTO font, int lineSize,
                                              int imageSize, int fixH, int fixW, Color color) {
        fixH -= 9;
        int marginW = fixW + lineSize;
        //设置字体
     ...
     * @return
     */
    public static BufferedImage drawFourFont(BufferedImage bi, Graphics2D g2d, SealDTO font, int lineSize,
                                             int imageSize, int fixH, int fixW, Color color) {
        //fixH -= 9;
        int marginW = fixW + lineSize;
        //设置字体
        ...
        switch (length) {
            ...
            case 7:
                marginH = 153;
                f = new Font(font.getFontFamily(), Font.BOLD, 31);
                //拉伸
            ...
            case 8:
                marginH = 153;
                f = new Font(font.getFontFamily(), Font.BOLD, 26);
                //拉伸
            ...
            case 11:
                marginH = 150;
                f = new Font(font.getFontFamily(), Font.BOLD, 21);
                //拉伸
            ...
            case 12:
                marginH = 150;
                f = new Font(font.getFontFamily(), Font.BOLD, 18);
                //拉伸
            ...
            case 15:
                marginH = 150;
                f = new Font(font.getFontFamily(), Font.BOLD, 14);
                //拉伸
